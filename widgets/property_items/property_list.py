...
class PropertyList(PropertyItem):
    def __init__(self):
        ...
        self.default_element_name: str = ''
        self.default_element_value = 0
    ...
    def set_default_values(self, *args):
        values, = args
        name, value = values
        self.default_element_name = name
        self.default_element_value = value
    ...
    def add_item(self):
        ...
        value = self.default_element_value
