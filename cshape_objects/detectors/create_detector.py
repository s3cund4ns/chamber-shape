from cshape_objects.detectors.lattice_detector import Lattice
from cshape_objects.detectors.material_detector import Material
from cshape_objects.detectors.mesh_detector import Mesh
