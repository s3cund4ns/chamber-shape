...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.materials_layout.setSpacing(0)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 298, 648))
        ...
        self.dock_detectors.setEnabled(True)
        self.dock_detectors_content = QWidget()
        self.dock_detectors_content.setObjectName(u"dock_detectors_content")
        self.detectors_layout_1 = QVBoxLayout(self.dock_detectors_content)
        self.detectors_layout_1.setSpacing(7)
        self.detectors_layout_1.setObjectName(u"detectors_layout_1")
        self.detectors_layout_1.setContentsMargins(0, 0, 0, 0)
        self.detectors_layout = QVBoxLayout()
        self.detectors_layout.setObjectName(u"detectors_layout")

        self.detectors_layout_1.addLayout(self.detectors_layout)

        self.dock_detectors.setWidget(self.dock_detectors_content)
